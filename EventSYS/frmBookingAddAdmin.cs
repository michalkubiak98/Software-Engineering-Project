...
namespace EventSYS
{
    public partial class frmBookingAddAdmin : Form
    {
        public frmBookingAddAdmin()
        {
            InitializeComponent();
        }
        ...
        private void frmBookingAddAdmin_MouseMove(object sender, MouseEventArgs e)
        {
            if (_dragging)
            {
        ...
        private void frmBookingAddAdmin_MouseUp(object sender, MouseEventArgs e)
        {
            _dragging = false;
        }

        private void frmBookingAddAdmin_MouseDown(object sender, MouseEventArgs e)
        {
            _dragging = true;
            _start_point = new Point(e.X, e.Y);
        }

        private void grdEvents_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void frmBookingAddAdmin_Load(object sender, EventArgs e)
        {
        ...
        private void cboTickets_SelectedIndexChanged_1(object sender, EventArgs e)
        {
